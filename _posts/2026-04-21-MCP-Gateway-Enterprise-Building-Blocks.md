...
graph TD
    ...
    style A fill:#666666,stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style B fill:#000088,stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style C fill:#008800,stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style D fill:#008800,stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style E fill:#008800,stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style F1 fill:#606060,stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style F2 fill:#606060,stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style F3 fill:#606060,stroke:#333,stroke-width:2px,color:#000,font-size:14px
</div>
...
graph TD
    ...
    style D fill:#008800, stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style E fill:#008800, stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style F fill:#008800, stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style G fill:#008800, stroke:#333,stroke-width:2px,color:#000,font-size:14px
</div>
...
<div class="mermaid">
graph TD
    subgraph D[Multi-Agent AI Application]
        A1[Agent 1: Planning]
    ...
    style A1 fill:#880000, stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style A2 fill:#880000, stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style A3 fill:#880000, stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style B fill:#000088, stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style C fill:#008800, stroke:#333,stroke-width:2px,color:#000,font-size:14px
    style D fill:#808080, stroke:#333,stroke-width:2px,color:#000,font-size:14px
</div>
